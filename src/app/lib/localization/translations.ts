...
export type TranslationsSchema = {
  ...
  orderEmail: typeof orderEmailSchema
...
export const translations: Record<Lang, TranslationsSchema> = {
  ee: {
    ...
    orderEmail: {
      hello: "Tere",
      thanksHtml: "Täname tellimuse eest saidil <strong>{site}</strong>!",
      thanksPlain: "Täname tellimuse eest saidil {site}!",
      orderDetails: "Tellimuse üksikasjad",
      order: "Tellimus",
      placed: "Esitatud",
      payment: "Makseviis",
      paymentValue: "Pangaülekanne (ootel)",
      tableCode: "Kood",
      tableProduct: "Teenus",
      tablePrice: "Hind",
      tableQty: "Kogus",
      tableSum: "Summa",
      itemsTotal: "Kokku",
      contactBlock: "Kontaktandmed",
      questionsLabel: "Küsimusi? Kirjuta meile:",
      phoneLabel: "Telefon",
      statusUpdateTitle: "Tellimuse staatus uuendatud",
      previousStatusLabel: "Eelmine staatus",
      newStatusLabel: "Uus staatus",
      updatedAtLabel: "Uuendatud",
      paymentDetailsTitle: "Makseandmed",
      bankTitle: "Pangaandmed ja juhised",
      accountLabel: "Konto number",
      credentialsLabel: "Rekvisiidid",
      instructionsLabel: "Juhised",
      ticketsNote: "Piletite valik (URL)",
      eventIdLabel: "Ürituse ID",
      processingFeeTest: "Töötlemistasu (test)",
      testLineItemsNote: "(Testread: 49,00 € + 1,99 € tasu = 50,99 €)",
      notesLabel: "Märkused",
      eventLabel: "Üritus",
    },
    category: {
  ...
  ru: {
    ...
    orderEmail: {
      hello: "Здравствуйте",
      thanksHtml: "Спасибо за заявку на <strong>{site}</strong>!",
      thanksPlain: "Спасибо за заявку на {site}!",
      orderDetails: "Детали заказа",
      order: "Заказ",
      placed: "Оформлен",
      payment: "Способ оплаты",
      paymentValue: "Банковский перевод (ожидается)",
      tableCode: "Код",
      tableProduct: "Услуга",
      tablePrice: "Цена",
      tableQty: "Кол-во",
      ...
      contactBlock: "Контактные данные",
      questionsLabel: "Есть вопросы? Напишите нам:",
      phoneLabel: "Телефон",
      statusUpdateTitle: "Статус заказа обновлён",
      previousStatusLabel: "Предыдущий статус",
      newStatusLabel: "Новый статус",
      updatedAtLabel: "Обновлено",
      paymentDetailsTitle: "Детали оплаты",
      bankTitle: "Реквизиты и инструкция",
      accountLabel: "Номер счёта",
      credentialsLabel: "Реквизиты",
      instructionsLabel: "Инструкция",
      ticketsNote: "Выбор билетов (параметр URL)",
      eventIdLabel: "ID события",
      processingFeeTest: "Сбор за обработку (тест)",
      testLineItemsNote: "(Тестовые строки: 49,00 € + 1,99 € сбор = 50,99 €)",
  ...
  en: {
    ...
    orderEmail: {
      hello: "Hello",
      thanksHtml: "Thank you for your request at <strong>{site}</strong>!",
      thanksPlain: "Thank you for your request at {site}!",
      orderDetails: "Order details",
      order: "Order",
      placed: "Placed",
      payment: "Payment method",
      paymentValue: "Bank transfer (pending)",
      tableCode: "Code",
      tableProduct: "Service",
      tablePrice: "Price",
      tableQty: "Qty",
      tableSum: "Line total",
      itemsTotal: "Items total",
      contactBlock: "Contact details",
      questionsLabel: "Any questions? Write to us:",
      phoneLabel: "Phone",
      statusUpdateTitle: "Order status updated",
      ...
      credentialsLabel: "Bank / recipient details",
      instructionsLabel: "Instructions",
      ticketsNote: "Ticket selection (URL param)",
      eventIdLabel: "Event ID",
      processingFeeTest: "Processing fee (test)",
      testLineItemsNote: "(Test line items: 49.00 € + 1.99 € fee = 50.99 €)",
      notesLabel: "Notes",
      eventLabel: "Event",
    },
    category: {
    ...
    orderEmail: {
      hello: "Hei",
      thanksHtml: "Kiitos tilauksestasi sivustolla <strong>{site}</strong>!",
      thanksPlain: "Kiitos tilauksestasi sivustolla {site}!",
      orderDetails: "Tilauksen tiedot",
      order: "Tilaus",
      placed: "Lähetetty",
      payment: "Maksutapa",
      paymentValue: "Tilisiirto (vireillä)",
      tableCode: "Koodi",
      tableProduct: "Palvelu",
      tablePrice: "Hinta",
      tableQty: "Määrä",
      tableSum: "Summa",
      itemsTotal: "Yhteensä",
      contactBlock: "Yhteystiedot",
      questionsLabel: "Kysyttävää? Kirjoita meille:",
      phoneLabel: "Puhelin",
      statusUpdateTitle: "Tilauksen tila päivitetty",
      previousStatusLabel: "Edellinen tila",
      newStatusLabel: "Uusi tila",
      updatedAtLabel: "Päivitetty",
      paymentDetailsTitle: "Maksutiedot",
      bankTitle: "Pankkitiedot ja ohjeet",
      accountLabel: "Tilinumero",
      credentialsLabel: "Tiedot",
      instructionsLabel: "Ohjeet",
      ticketsNote: "Lippuvalinta (URL)",
      eventIdLabel: "Tapahtuman tunnus",
      processingFeeTest: "Käsittelymaksu (testi)",
      testLineItemsNote: "(Testirivit: 49,00 € + 1,99 € maksu = 50,99 €)",
